...
//    }
//    [self jsReplace:url];
//    UIViewController *weexVC = [YTXModule  objectForURL:@"object://YTXDTNWBWeexContainerBusinessModule/WeexContainerViewController" withUserInfo:@{@"weexBundleURLString": transformURL}];
...
//}
//
//- (IBAction)goToHistory:(UIBarButtonItem *)sender {
//}
//
...
//            UIViewController *weexVC = [YTXModule  objectForURL:@"object://YTXDTNWBWeexContainerBusinessModule/WeexContainerViewController" withUserInfo:@{@"weexBundleURLString": [[elts lastObject]  stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding]}];
//            [self.navigationController pushViewController:weexVC animated:YES];
//            return YES;
...
////            UIViewController *weexVC = [YTXModule  objectForURL:@"object://YTXDTNWBWeexContainerBusinessModule/WeexContainerViewController" withUserInfo:@{@"weexBundleURLString": devToolURL}];
////            [self.navigationController pushViewController:weexVC animated:YES];
//            return YES;
//        }
//    }
